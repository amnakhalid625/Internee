...
export default function Footer() {
  return (
    <footer className="bg-background text-text rounded-t-[100px] px-6 md:px-24 pt-20 pb-6">
      {/* Newsletter */}
      <div className="md:flex justify-between items-center border-b border-gray-700 pb-10">
        ...
        <form className="mt-6 md:mt-0 flex max-w-md w-full">
          ...
          <button
            type="submit"
            className="bg-primary hover:opacity-90 text-white px-6 py-3 rounded-r-full"
          >
            Subscribe
          </button>
        </form>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-16 pb-10">
        ...
        <div>
          <div className="flex items-center space-x-3 mb-4">
            <span className="text-2xl font-bold">EliteTech</span>
          </div>
          ...
          <p className="text-gray-400 flex items-center gap-2 mt-1">
            <Mail size={16} /> @EliteTech.pk
          </p>
          <div className="flex gap-3 mt-4">
            <a href="#" className="bg-primary p-2 rounded-full hover:scale-110 transition">
              <Facebook size={18} />
            </a>
            <a href="#" className="bg-primary p-2 rounded-full hover:scale-110 transition">
              <Twitter size={18} />
      ...
      <div className="border-t border-gray-700 pt-4 mt-6 text-sm text-gray-500 flex flex-col md:flex-row justify-between items-center">
        <span>© 2025 EliteTech — All rights reserved</span>
